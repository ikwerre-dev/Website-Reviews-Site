            ...
            <div className="relative overflow-hidden backdrop-blur-lg py-[2rem] md:py-[5rem] pb-24 shadow-md bg-[#EAE8FF] rounded-[1rem]">
                <div className="flex flex-col py-5 px-5 md:px-[5rem] justify-center items-center">
                    <div className="border border-[#EAE8FF] text-[#EAE8FF] text-opacity-80 p-2 px-5 rounded-[5rem] bg-black border-20">
                        <h5 className="cursor-pointer whitespace-nowrap">Trusted Reviews, Honest Opinions</h5>
                    </div>
                    <div className="flex flex-col gap-[2rem] md:gap-[3rem] items-center py-[3rem]">
                        <h3 className="text-black text-3xl text-center md:text-5xl font-bold">Find the Companies You Can Rely On</h3>
                        <h6 className="text-black text-md md:text-2xl text-center">Browse authentic reviews from real customers and make informed decisions.</h6>
                    </div>
                    <div className="md:pt-5">
                        <Link to={'/search'} className="flex flex-row gap-5 rounded-xl bg-black text-[#EAE8FF] px-5 py-3">
